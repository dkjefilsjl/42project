...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/05 03:31:29 by seoyepar          #+#    #+#             */
/*   Updated: 2022/07/05 03:47:00 by seoyepar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map_ess(t_sl *sl)
{
	...
	if (count_p != 1)
		ft_exit("Map error. Please give me only one P\n");
...
{
	sl->w_cnt++;
	printf("The final number of steps you take is %d\n", sl->w_cnt);
